...
with open(r'D:\ANN Classification\label_encoder_gender.pkl','rb') as file:
    label_endcoder_gender=pickle.load(file)

with open(r'D:\ANN Classification\Ohe_encoder_geo.pkl','rb') as file:
    Ohe_encoder_geo=pickle.load(file)

with open(r'D:\ANN Classification\scaler.pkl','rb') as file:
